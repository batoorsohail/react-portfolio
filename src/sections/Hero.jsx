  ...
  return (
    <section className="flex md:items-center justify-center md:justify-between bg-black dark:bg-white h-[90vh] md:p-28">
      <div className="flex flex-col gap-2 p-5 mt-10 md:mt-0">
        <p className="text-white dark:text-black">Hi there, I am</p>
        ...
        <div>
          <p className="almost-gray text-base md:text-xl">A multi-skilled full-stack developer with hands-on experience in developing and maintaining web apps.</p>
          <p className="almost-gray text-base md:text-xl mb-5">Currently, I am working as a self employed developer and I am looking for a full time job as a full stack developer.</p>
        </div>
